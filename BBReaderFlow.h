...
{
public:
	BBReaderFlow(const std::string& filename, size_t container_size = 4096);
	...
	bool read_while_not(std::string& str, std::string word);// читает пока не достигнут word или конец файла, сам word не читает
